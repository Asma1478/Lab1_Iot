...
def on_message(client, userdata, msg):
    print(f'Received topic: {msg.topic} with playload: ACK_MSG_RECEIVED, at subscribers local time: {dt} \n')
...
def on_connect(client, userdata, flags, rc):
    ...
    if rc == 0:
        ...
        print(f"Subscribed to topic: {TOPIC_D}")
